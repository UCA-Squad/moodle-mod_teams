...
$string['teams:name'] = 'Resource name';
$string['teams:name_help'] = 'Resource name which will be displayed on your course page. A prefix will be added to identify the type of the ressource.';
$string['teams:desc'] = '<div class="alert alert-info">Team creation is an action which can take few seconds.<br/>
...
$string['teams:noaccount'] = '<p>It seems you do not have any microsoft account, so you cannot create a Team for now.</p>
                                <p>With your account created come back here to create your team from moodle.</p>';
$string['teams:error'] = '<p>It seems an error occured during your team creation: "{$a}".</p>
                                <p>Please retry this operation and contact the support if this problem persists.</p>';

$string['teams:back'] = 'Return to course';
$string['teams:type'] = 'Teams resource type to create';
$string['teams:type_help'] = 'Teams resource type to create: 
...
$string['teams:team'] = 'Team<br/>';
$string['teams:meeting'] = 'Online meeting<br/>Virtual classroom';
$string['teams:team_prefix'] = '[TEAM] ';
$string['teams:meeting_prefix'] = '[ONLINE MEETING] ';
$string['teams:population'] = 'Population ';
$string['teams:population_help'] = '<p>Select the populaton you want to enrol to the team:
...
$string['teams:population_all'] = 'Enrolled users (students + teachers)';
$string['teams:population_groups'] = 'One group or more';
$string['teams:population_users'] = 'Chosen users';
$string['teams:enrol_managers'] = 'Enrol all course managers as team owners';
$string['teams:enrol_managers_help'] = 'If enable all users with the "manager" role will be add to the team as owner and will have administration rights on it.<br/>
                                           If don\'t, you, as creator of the team, will be the only owner of this team.';
$string['teams:opendate'] = 'Start date of the meeting';
$string['teams:opendate_help'] = 'Start date of the meeting. If this option is not selected the meeting will be avalaible since its creation.';
$string['teams:opendate_session'] = ' (Teams session start)';
$string['teams:closedate'] = 'Closing date of the meeting';
$string['teams:closedate_help'] = 'Closing date of the resource. If this option is not selected the meeting will be avalaible until another action from one of the organizers.';
$string['teams:closedate_session'] = ' (Teams session end)';
$string['teams:dates_help'] = '<div class="alert alert-info"><strong>Be careful, the meeting created on this page will not be displayed on the Teams calendar. You can only see it on the Moodle calendar. Students will not receive email notifications for this meeting.</strong>';
$string['teams:dates_between'] = 'between %s and %s';
$string['teams:dates_from'] = 'from %s';
$string['teams:dates_until'] = 'until %s';
$string['teams:error_groups'] = 'Please select at least one group or change the population field value.';
$string['teams:error_users'] = 'Please select at least one enrolled user or change the population field value.';
$string['teams:error_dates'] = 'Closing date must be later than start date.';
$string['teams:no_owner'] = '<p>You are not a owner of this team so that\'s why you cannot edit its properties.</p>
...
$string['teams:description'] = 'Team created for the course "%s".';
