...
$string['teams:name'] = 'Nom de la ressource Teams';
$string['teams:name_help'] = 'Nom de la ressource Teams qui sera affiché sur la page de votre cours. Un préfixe pourra être ajouté avant celui-ci pour identifier le type de ressource.';
$string['teams:desc'] = '<div class="alert alert-info">La création d\'une équipe Teams depuis la plateforme Moodle est une action qui peut prendre quelques secondes.<br/>
...
$string['teams:noaccount'] = '<p>Il semblerait que vous n\'ayez pas encore de compte microsoft enregistré, vous ne pouvez donc pour l\'instant pas créer de team.</p>
                                <p>Une fois votre compte créé vous pourrez ensuite revenir pour créer votre team depuis moodle.</p>';
$string['teams:error'] = '<p>Il semblerait qu\'une erreur se soit produite lors de votre tentative de création de la team: "{$a}".</p>
                                <p>Retentez l\'opération, si le souci persiste, contactez le support.</p>';
$string['teams:back'] = 'Revenir au cours';
$string['teams:type'] = 'Type de ressource Teams à créer';
$string['teams:type_help'] = 'Type de ressource Teams à créer: 
...
$string['teams:team'] = 'Equipe Teams<br/>';
$string['teams:meeting'] = 'Réunion Teams<br/> Classe virtuelle';
$string['teams:team_prefix'] = '[EQUIPE] ';
$string['teams:meeting_prefix'] = '[REUNION] ';
$string['teams:population'] = 'Population ciblée';
$string['teams:population_help'] = '<p>Choisissez la population que vous voulez inscrire à votre team:
...
$string['teams:population_all'] = 'Tous les inscrits au cours (étudiants + enseignants)';
$string['teams:population_groups'] = 'Un ou plusieurs groupes';
$string['teams:population_users'] = 'Des utilisateurs précis';
$string['teams:enrol_managers'] = 'Inscrire les autres gestionnaires du cours comme propriétaire';
$string['teams:enrol_managers_help'] = 'Si ce réglage est activé tous les utilisateurs possédant le rôle de "gestionnaire" sur le cours seront également ajoutés comme propriétaire de la team et posséderont des droits d\'administration sur celle-ci.<br/>
...
$string['teams:opendate'] = 'Début de la réunion';
$string['teams:opendate_help'] = 'Date à partir de laquelle la ressource sera disponible. Si cette option n\'est pas activée la réunion sera disponible dès sa création.';
$string['teams:opendate_session'] = ' (Début réunion Teams)';
$string['teams:closedate'] = 'Fin de la réunion';
$string['teams:closedate_help'] = 'Date à partir de laquelle la ressource ne plus sera disponible. Si cette option n\'est pas activée la réunion restera disponible sans autre action d\'un des organisateurs.';
$string['teams:closedate_session'] = ' (Fin réunion Teams)';
$string['teams:dates_help'] = '<div class="alert alert-info"><strong>Attention, la réunion créée depuis cette interface ne sera pas accessible depuis le Calendrier Teams. Vous ne pourrez y accéder que depuis Moodle. Les étudiants ne recevront pas de notification de cette réunion sur leur messagerie.</strong>';
$string['teams:dates_between'] = 'entre le %s et le %s';
$string['teams:dates_from'] = 'à partir du %s';
$string['teams:dates_until'] = 'jusqu\'au %s';
$string['teams:error_groups'] = 'Veuillez choisir au moins un groupe ou bien changez la valeur du type de population.';
$string['teams:error_users'] = 'Veuillez choisir au moins un utilisateur ou bien changez la valeur du type de population.';
$string['teams:error_dates'] = 'La date de fin doit être postérieure que la date d\'ouverture.';
$string['teams:no_owner'] = '<p>Vous n\'ếtes pas propriétaire de cette team, vous ne pouvez donc pas éditer les propriétés de celle-ci.</p>
...
$string['teams:description'] = 'Equipe créée dans le cadre du cours "%s".';
